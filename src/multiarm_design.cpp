  ...
  if (rho == 0 || M == 1) {
    ...
    for (size_t k = 1; k <= kMax; ++k) {
      ...
      for (std::uint64_t i = 0; i < totalComb; ++i) {
        ...
        if (uniform_arms) {
          // All M arms share identical bounds at every stage.
    ...
    for (size_t k = 1; k <= kMax; ++k) {
      ...
      for (std::uint64_t i = 0; i < totalComb; ++i) {
        ...
        if (k > 1) {
          ...
          double p1;
          if (use_chol2) {
            p1 = pmvnorm_with_chol(chol2, lower2, upper2, zero2).prob;
          } else {
            p1 = pmvnormcpp(lower2, upper2, zero2, sigma1).prob;
          }
          vupper1 += sign * p1;
        }
        ...
        double p2;
        if (use_chol1) {
          p2 = pmvnorm_with_chol(chol1, lower1m, c, zero1).prob;
        } else {
          p2 = pmvnormcpp(lower1m, c, zero1, sigma1).prob;
        }
        vupper2 += sign * p2;
        ...
        double p3;
        if (use_chol1) {
          p3 = pmvnorm_with_chol(chol1, lower1m, c, zero1).prob;
        } else {
          p3 = pmvnormcpp(lower1m, c, zero1, sigma1).prob;
        }
        vlower += sign * p3;
