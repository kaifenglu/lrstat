...
- add efficacyStopping to the getBoundcpp function to improve coding efficiency
...
- calculated cumulative alpha spent considering futility stopping in the getDesign function
