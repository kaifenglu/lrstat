...
power for a group sequential design for equivalence in two-sample odds
ratio.
...
- `byStageResults`: A data frame containing the following variables:
  ...
  - `efficacyOddsRatioLower`: The efficacy boundaries on the odds ratio
    scale for the one-sided null hypothesis on the lower equivalence
    limit.

  - `efficacyOddsRatioUpper`: The efficacy boundaries on the odds ratio
...
#>                                                                                              
#> Group-sequential design with 3 stages for equivalence in two-sample odds ratio               
#> Lower limit for odds ratio: 0.8, upper limit for odds ratio: 1.25                            
#> Proportion on treatment: 0.12, proportion on control: 0.12, odds ratio: 1                    
#> Overall power: 0.8, overall alpha (1-sided): 0.05, attained under H10: 0.05, under H20: 0.05 
#> Max information: 175.22, expected under H1: 162.63, under H10: 174.47, under H20: 174.47     
#> Max # subjects: 6637, expected under H1: 6160.2, under H10: 6608.8, under H20: 6608.8        
...
#> Cumulative rejection                   0.0000  0.2156  0.8000 
...
#> Number of subjects                     2212.0  4425.0  6637.0 
#> Boundary for lower limit (odds ratio)  1.216   0.975   0.909  
#> Boundary for upper limit (odds ratio)  0.822   1.025   1.100  
#> Boundary for each 1-sided test (p)     0.0007  0.0161  0.0451 
#> Information                            58.40   116.82  175.22 
```
