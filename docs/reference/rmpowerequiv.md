...
Obtains the power for equivalence in restricted mean survival time
difference.
...
- `overallResults`: A data frame containing the following variables:
  ...
  - `rmstDiffLower`: The lower equivalence limit of restricted mean
    survival time difference.

  - `rmstDiffUpper`: The upper equivalence limit of restricted mean
    survival time difference.
...
- `byStageResults`: A data frame containing the following variables:
  ...
  - `efficacyRmstDiffLower`: The efficacy boundaries on the restricted
    mean survival time difference scale for the one-sided null
    hypothesis at the lower equivalence limit.

  - `efficacyRmstDiffUpper`: The efficacy boundaries on the restricted
    mean survival time difference scale for the one-sided null
