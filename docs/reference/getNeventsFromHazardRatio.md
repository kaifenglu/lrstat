...
Obtains the required number of events given the hazard ratios under the
null and alternative hypotheses for a group sequential design.
...
- informationRates:
  ...
  The information rates in terms of number of events. Fixed prior to the
  trial. Defaults to `(1:kMax) / kMax` if left unspecified.
