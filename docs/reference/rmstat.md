...
Obtains the stratified restricted mean survival times and difference in
restricted mean survival times at given calendar times.
...
- `rmstDiff`: The difference in restricted mean survival times, i.e.,
  `rmst1 - rmst2`.
