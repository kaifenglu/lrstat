...
fPCStagewiseRcpp <- function(stg2_p, wgtmat, family, corr, stg1_inthyp_nr_idx, stg2_elemhyp_idx, stg2_wgtmat, test = "dunnett") {
    .Call(`_lrstat_fPCStagewiseRcpp`, stg2_p, wgtmat, family, corr, stg1_inthyp_nr_idx, stg2_elemhyp_idx, stg2_wgtmat, test)
}
