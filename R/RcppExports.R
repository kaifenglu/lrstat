...
fadjpRcpp <- function(wgtmat, family, corr, stg1_inthyp_nr, stg2_elemhyp, stg2_wgtmat, stg2_p, test = "dunnett") {
    .Call(`_lrstat_fadjpRcpp`, wgtmat, family, corr, stg1_inthyp_nr, stg2_elemhyp, stg2_wgtmat, stg2_p, test)
}

fPCStage1Rcpp <- function(m, stg1_loc_p, alpha1) {
    .Call(`_lrstat_fPCStage1Rcpp`, m, stg1_loc_p, alpha1)
}

fPCrejRcpp <- function(stg1_elemhyp_r_idx, stg2_elemhyp_idx, stg1_loc_p, stg2_loc_p, alpha, info_frac) {
    .Call(`_lrstat_fPCrejRcpp`, stg1_elemhyp_r_idx, stg2_elemhyp_idx, stg1_loc_p, stg2_loc_p, alpha, info_frac)
}

fStageBoundRcpp <- function(m, wgtmat, family, corr, alpha, alpha1, info_frac) {
    .Call(`_lrstat_fStageBoundRcpp`, m, wgtmat, family, corr, alpha, alpha1, info_frac)
}

fCERRcpp <- function(m, wgtmat, family, corr, info_frac, stg1_bnd, stg2_bnd, stg1_p) {
    .Call(`_lrstat_fCERRcpp`, m, wgtmat, family, corr, info_frac, stg1_bnd, stg2_bnd, stg1_p)
}

fNewBoundRcpp <- function(m, wgtmat, family, corr, stg1_p, stg1_inthyp_nr_idx, CER, stg2_elemhyp_idx, stg2_wgtmat, info_frac_new) {
    .Call(`_lrstat_fNewBoundRcpp`, m, wgtmat, family, corr, stg1_p, stg1_inthyp_nr_idx, CER, stg2_elemhyp_idx, stg2_wgtmat, info_frac_new)
}

fCERrejRcpp <- function(stg1_elemhyp_r_idx, stg2_elemhyp_idx, stg2_inthyp, stg2_bnd_new, cum_p) {
    .Call(`_lrstat_fCERrejRcpp`, stg1_elemhyp_r_idx, stg2_elemhyp_idx, stg2_inthyp, stg2_bnd_new, cum_p)
}
...
#'
#' @export
getCI_multiarm <- function(M = NA_integer_, r = 1, corr_known = TRUE, L = NA_integer_, zL = NA_real_, IMax = NA_real_, informationRates = NA_real_, efficacyStopping = NA_integer_, criticalValues = NULL, alpha = 0.025, typeAlphaSpending = "sfOF", parameterAlphaSpending = NA_real_, spendingTime = NA_real_) {
    .Call(`_lrstat_getCI_multiarm`, M, r, corr_known, L, zL, IMax, informationRates, efficacyStopping, criticalValues, alpha, typeAlphaSpending, parameterAlphaSpending, spendingTime)
}
...
#'
#' @export
getADCI_multiarm <- function(M = NA_integer_, r = 1, corr_known = TRUE, L = NA_integer_, zL = NA_real_, IMax = NA_real_, kMax = NA_integer_, informationRates = NA_real_, efficacyStopping = NA_integer_, criticalValues = NULL, alpha = 0.25, typeAlphaSpending = "sfOF", parameterAlphaSpending = NA_real_, spendingTime = NA_real_, MullerSchafer = FALSE, MNew = NA_integer_, selected = NA_integer_, rNew = 1, Lc = NA_integer_, zLc = NA_real_, INew = NA_real_, informationRatesNew = NA_real_, efficacyStoppingNew = NA_integer_, typeAlphaSpendingNew = "sfOF", parameterAlphaSpendingNew = NA_real_, spendingTimeNew = NA_real_) {
    .Call(`_lrstat_getADCI_multiarm`, M, r, corr_known, L, zL, IMax, kMax, informationRates, efficacyStopping, criticalValues, alpha, typeAlphaSpending, parameterAlphaSpending, spendingTime, MullerSchafer, MNew, selected, rNew, Lc, zLc, INew, informationRatesNew, efficacyStoppingNew, typeAlphaSpendingNew, parameterAlphaSpendingNew, spendingTimeNew)
}
...
#'
#' @export
exitprob_multiarm <- function(M = NA_integer_, r = 1, theta = NA_real_, corr_known = TRUE, kMax = NA_integer_, b = NULL, a = NULL, I = NULL) {
    .Call(`_lrstat_exitprob_multiarm`, M, r, theta, corr_known, kMax, b, a, I)
}
...
#'
#' @export
getBound_multiarm <- function(M = NA_integer_, r = 1, corr_known = TRUE, k = NA_integer_, informationRates = NA_real_, alpha = 0.025, typeAlphaSpending = "sfOF", parameterAlphaSpending = NA_real_, userAlphaSpending = NA_real_, spendingTime = NA_real_, efficacyStopping = NA_integer_) {
    .Call(`_lrstat_getBound_multiarm`, M, r, corr_known, k, informationRates, alpha, typeAlphaSpending, parameterAlphaSpending, userAlphaSpending, spendingTime, efficacyStopping)
}
...
getDesign_multiarm <- function(beta = NA_real_, IMax = NA_real_, theta = NA_real_, M = NA_integer_, r = 1, corr_known = TRUE, kMax = 1L, informationRates = NA_real_, efficacyStopping = NA_integer_, futilityStopping = NA_integer_, criticalValues = NULL, alpha = 0.025, typeAlphaSpending = "sfOF", parameterAlphaSpending = NA_real_, userAlphaSpending = NA_real_, futilityBounds = NULL, futilityCP = NULL, futilityTheta = NULL, typeBetaSpending = "none", parameterBetaSpending = NA_real_, userBetaSpending = NA_real_, spendingTime = NA_real_) {
    .Call(`_lrstat_getDesign_multiarm`, beta, IMax, theta, M, r, corr_known, kMax, informationRates, efficacyStopping, futilityStopping, criticalValues, alpha, typeAlphaSpending, parameterAlphaSpending, userAlphaSpending, futilityBounds, futilityCP, futilityTheta, typeBetaSpending, parameterBetaSpending, userBetaSpending, spendingTime)
}
...
#'
#' @export
adaptDesign_multiarm <- function(betaNew = NA_real_, INew = NA_real_, M = NA_integer_, r = 1, corr_known = TRUE, L = NA_integer_, zL = NA_real_, theta = NA_real_, IMax = NA_real_, kMax = NA_integer_, informationRates = NA_real_, efficacyStopping = NA_integer_, futilityStopping = NA_integer_, criticalValues = NULL, alpha = 0.025, typeAlphaSpending = "sfOF", parameterAlphaSpending = NA_real_, userAlphaSpending = NA_real_, futilityBounds = NULL, futilityCP = NULL, futilityTheta = NULL, spendingTime = NA_real_, MullerSchafer = FALSE, MNew = NA_integer_, selected = NA_integer_, rNew = 1, kNew = NA_integer_, informationRatesNew = NA_real_, efficacyStoppingNew = NA_integer_, futilityStoppingNew = NA_integer_, typeAlphaSpendingNew = "sfOF", parameterAlphaSpendingNew = NA_real_, futilityBoundsInt = NULL, futilityCPInt = NULL, futilityThetaInt = NULL, typeBetaSpendingNew = "none", parameterBetaSpendingNew = NA_real_, userBetaSpendingNew = NA_real_, spendingTimeNew = NA_real_) {
    .Call(`_lrstat_adaptDesign_multiarm`, betaNew, INew, M, r, corr_known, L, zL, theta, IMax, kMax, informationRates, efficacyStopping, futilityStopping, criticalValues, alpha, typeAlphaSpending, parameterAlphaSpending, userAlphaSpending, futilityBounds, futilityCP, futilityTheta, spendingTime, MullerSchafer, MNew, selected, rNew, kNew, informationRatesNew, efficacyStoppingNew, futilityStoppingNew, typeAlphaSpendingNew, parameterAlphaSpendingNew, futilityBoundsInt, futilityCPInt, futilityThetaInt, typeBetaSpendingNew, parameterBetaSpendingNew, userBetaSpendingNew, spendingTimeNew)
}
...
fadjpbonRcpp <- function(wgtmat, p) {
    .Call(`_lrstat_fadjpbonRcpp`, wgtmat, p)
}

fadjpsimRcpp <- function(wgtmat, p, family) {
    .Call(`_lrstat_fadjpsimRcpp`, wgtmat, p, family)
}

fadjpdunRcpp <- function(wgtmat, p, family, corr) {
    .Call(`_lrstat_fadjpdunRcpp`, wgtmat, p, family, corr)
}
