...
fadjpRcpp <- function(stg2_p, wgtmat, family, corr, stg1_inthyp_nr, stg2_elemhyp, stg2_wgtmat, test = "dunnett") {
    .Call(`_lrstat_fadjpRcpp`, stg2_p, wgtmat, family, corr, stg1_inthyp_nr, stg2_elemhyp, stg2_wgtmat, test)
}
