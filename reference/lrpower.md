...
- `overallResults`: A data frame containing the following variables:
  ...
  - `typeOfComputation`: The type of computation, either "direct" for
    the direct approximation method, or "schoenfeld" for the Schoenfeld
    method.
...
#> Overall power: 0.7789, overall significance level (1-sided): 0.025   
#> Maximum # events: 307.5, expected # events: 281.6                    
#> Maximum # dropouts: 29, expected # dropouts: 26.3                    
#> Maximum # subjects: 468, expected # subjects: 468                    
#> Maximum information: 76.19, expected information: 69.91              
#> Total study duration: 40, expected study duration: 36.1              
...
#> Cumulative rejection   0.4213  0.7789 
#> Cumulative alpha spent 0.0122  0.0250 
#> Number of events       246.0   307.5  
#> Number of dropouts     22.5    29.0   
#> Number of subjects     468.0   468.0  
#> Analysis time          30.6    40.0   
#> Efficacy boundary (HR) 0.749   0.792  
#> Efficacy boundary (p)  0.0122  0.0214 
#> Information            61.29   76.19  
#> HR                     0.769   0.727  
```
