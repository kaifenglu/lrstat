...
Obtains the power and sample size for equivalence in direct treatment
...
- meanDiffLower:
  ...
  The lower equivalence limit of mean difference for the treatment pair
  of interest.

- meanDiffUpper:

  The upper equivalence limit of mean difference for the treatment pair
  of interest.
...
- `meanDiffLower`: The lower equivalence limit of mean difference for
  the treatment pair of interest.

- `meanDiffUpper`: The upper equivalence limit of mean difference for
  the treatment pair of interest.
