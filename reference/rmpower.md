...
Estimates the power for testing the difference in restricted mean
survival times in a two-sample survival design.
...
- `overallResults`: A data frame containing the following variables:
  ...
  - `rmstDiff`: The difference in restricted mean survival times, equal
    to `rmst1 - rmst2`.
...
- `byStageResults`: A data frame containing the following variables:
  ...
  - `efficacyRmstDiff`: The efficacy boundaries on the restricted mean
    survival time difference scale.

  - `futilityRmstDiff`: The futility boundaries on the restricted mean
    survival time difference scale.
...
#> Overall power: 0.3042, overall significance level (1-sided): 0.025                    
#> Maximum # events: 356.4, expected # events: 333.2                                     
#> Maximum # subjects: 468, expected # subjects: 468                                     
#> Maximum information: 2.62, expected information: 2.53                                 
#> Total study duration: 40, expected study duration: 37.2                               
...
#> Cumulative rejection          0.1739  0.3042 
#> Cumulative alpha spent        0.0122  0.0250 
#> Number of events              223.3   356.4  
#> Number of dropouts            14.0    24.2   
#> Number of subjects            468.0   468.0  
#> Number of milestone subjects  17.2    140.9  
#> Analysis time                 23.8    40.0   
#> Efficacy boundary (rmst diff) 1.554   1.251  
#> Efficacy boundary (p)         0.0122  0.0214 
#> Information                   2.10    2.62   
```
